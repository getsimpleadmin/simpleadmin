...
ActiveRecord::Schema.define(version: 20_170_810_123_745) do
  ...
  create_table 'simple_admin_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[resource_type resource_id], name: 'index_simple_admin_roles_on_resource_type_and_resource_id'
  end
